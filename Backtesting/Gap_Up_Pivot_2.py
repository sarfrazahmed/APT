...
input_file = 'TataMotors_5min.csv'
output_file = 'Gap_Up_Strategy_Output_TataMotors_pivot.csv'
lot_size = 3000
min_gap = 0.01
min_target = 3500
max_stop_loss = 3500
            ...
            if order_status == 'Exit':
                ...
                if trade_count == 0:
                    ...
                    if ads_iteration.Close[i] > entry_high_target:
                        ...
                        target = min_pos_delta + order_price
                    ...
                    # Short Entry Action
                        ...
                        target = order_price + max_neg_delta
